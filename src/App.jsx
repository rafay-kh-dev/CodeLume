...
function RouteTracker() {
  ...
  if (pathname === "/") {
    ...
    pageTitle = "Custom PHP & Laravel Development | Secure Backends | CodeLume";
    ...
    pageTitle = "Angular Web App Development | Enterprise SPAs | CodeLume";
    ...
    pageTitle = "Custom Shopify Development | E-Commerce Stores | CodeLume";
    ...
    pageTitle = "Webflow Design Agency | Interactive Websites | CodeLume";
    ...
    pageTitle = "Custom Mobile App Development | iOS & Android | CodeLume";
    ...
    pageTitle = "UI/UX Design Services | Figma Prototyping | CodeLume";
    ...
    pageTitle = "The CodeLume Blog | Web Dev & Design Insights";
