...
export default function PremiumReviewsSlider() {
  ...
  const ReviewCard = ({ review }) => (
    ...
    <div className="group w-[300px] sm:w-[380px] shrink-0 flex flex-col p-6 sm:p-7 bg-gradient-to-b from-[#0a0f1c] to-[#030712] border border-white/5 rounded-[24px] hover:border-blue-500/40 transition-all duration-500 cursor-default relative hover:-translate-y-2 shadow-[0_8px_30px_rgba(0,0,0,0.4)] hover:shadow-[0_15px_40px_-10px_rgba(37,99,235,0.25)] overflow-hidden">
      ...
      <h2 className="text-[14px] sm:text-[15px] text-slate-300 font-medium leading-[1.7] mb-6 m-0 min-h-[90px] group-hover:text-slate-100 transition-colors duration-300 relative z-10">
        "{review.content}"
      </h2>
      ...
      <div className="mt-auto pt-5 border-t border-white/5 flex items-center justify-between group-hover:border-blue-500/20 transition-colors duration-500 relative z-10">
        <div className="flex items-center gap-3.5">
          ...
          <div className="flex flex-col">
            ...
            <h2 className="text-[11px] sm:text-[12px] text-slate-500 font-medium m-0 truncate max-w-[180px] group-hover:text-blue-200/70 transition-colors">
              {review.role}
            </h2>
          </div>
        </div>
