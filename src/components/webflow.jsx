...
export default function WebflowService() {
  ...
  const packages = [
    {
      name: "Landing Page",
      price: "$149",
      description: "A stunning, high-converting single page website designed to capture leads.",
      popular: false,
      buttonText: "Order Landing Page",
      features: [
        { name: "Pixel-perfect Custom Design", included: true },
        { name: "Responsive Mobile UI", included: true },
        { name: "Basic Scroll Animations", included: true },
        { name: "Contact Form Setup", included: true },
        { name: "Webflow CMS Setup", included: false },
        { name: "Figma to Webflow Transfer", included: false },
        { name: "Advanced Lottie Animations", included: false },
    ...
    {
      name: "CMS Business Site",
      price: "$299",
      description: "The ideal package for dynamic business websites, portfolios, and blogs.",
      popular: true,
      buttonText: "Order Business Site",
      features: [
        { name: "Up to 8 Custom Pages", included: true },
        { name: "Responsive Mobile UI", included: true },
        { name: "Advanced Micro-interactions", included: true },
        { name: "Advanced Form & Logic", included: true },
        { name: "Webflow CMS Setup", included: true },
        { name: "Figma to Webflow Transfer", included: true },
        { name: "Advanced Lottie Animations", included: false },
        { name: "E-commerce Functionality", included: false },
    ...
    },
    {
      ...
      price: "$499",
      description: "A fully bespoke, award-winning web experience with complex animations.",
      popular: false,
      buttonText: "Go Premium",
      features: [
        { name: "Unlimited Pages & Layouts", included: true },
        { name: "Responsive Mobile UI", included: true },
        { name: "Complex GSAP/Interactions", included: true },
        { name: "Advanced Form & Logic", included: true },
        { name: "Advanced Webflow CMS", included: true },
        { name: "Figma to Webflow Transfer", included: true },
        { name: "Advanced Lottie Animations", included: true },
  ...
  return (
    <div className="min-h-dvh bg-[#030712] text-white font-jakarta pt-24 md:pt-28 pb-20 md:pb-24 overflow-hidden relative">
      ...
      {/* Deep Glow Background (Purple) */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-5xl h-[700px] bg-[radial-gradient(ellipse_at_top,rgba(168,85,247,0.15)_0%,transparent_70%)] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        ...
        <div className="flex flex-col items-center text-center mb-12 md:mb-24 max-w-4xl mx-auto">
          ...
          <h2 className="text-[12px] md:text-[13px] font-black text-purple-500 uppercase tracking-[0.3em] mb-4 m-0 flex items-center justify-center gap-2">
            <Layout className="w-4 h-4" /> Visual Development
          </h2>
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black text-white tracking-tighter leading-[1.05] m-0 mb-4 md:mb-6 drop-shadow-2xl">
            Pixel-Perfect <br className="hidden sm:block" />
            <span className="text-transparent bg-clip-text bg-linear-to-r from-purple-400 via-purple-500 to-fuchsia-500">
              Webflow Sites
            </span>
          </h1>
          
          <p className="text-slate-400 text-[15px] sm:text-lg lg:text-xl leading-relaxed max-w-2xl mx-auto font-medium">
            Lightning-fast, visually stunning responsive websites with advanced animations and seamless CMS integration.
          </p>
        </div>
            ...
            {packages.map((pkg, index) => (
              <div 
                ...
                className={`w-[85vw] sm:w-[70vw] shrink-0 snap-center md:w-auto relative flex flex-col bg-[#0a0f1c] rounded-3xl md:rounded-4xl p-6 md:p-8 lg:p-10 transition-all duration-500 hover:-translate-y-2 h-full ${
                  pkg.popular 
                  ? "border border-purple-500/50 shadow-[0_0_50px_rgba(168,85,247,0.15)] bg-linear-to-b from-[#0a0f1c] to-[#120c1a] lg:scale-105 z-10" 
                  : "border border-white/5 hover:border-white/10 hover:shadow-2xl"
                }`}
              >
                {pkg.popular && (
                  <div className="absolute -top-4 md:-top-5 left-1/2 -translate-x-1/2 bg-linear-to-r from-purple-600 to-fuchsia-600 text-white text-[10px] md:text-[12px] font-black uppercase tracking-widest px-5 py-1.5 md:py-2 rounded-full shadow-[0_10px_20px_rgba(168,85,247,0.3)] border border-purple-400/30 whitespace-nowrap">
                    Most Popular
                  </div>
                )}
                ...
                <div className="flex flex-col gap-3 md:gap-4 mb-8 md:mb-10 flex-grow">
                  ...
                  {pkg.features.map((feature, i) => (
                    <div key={i} className="flex items-center gap-3 group">
                      {feature.included ? (
                        <div className="w-4 h-4 md:w-5 md:h-5 rounded-full bg-purple-500/20 flex items-center justify-center shrink-0">
                ...
                <a
                  href={`https://wa.me/923347835980?text=Hi%20Rafay!%20I%20am%20interested%20in%20the%20${encodeURIComponent(pkg.name)}%20Webflow%20package%20for%20${pkg.price}.`}
                  target="_blank"
                  rel="noreferrer"
                  className={`w-full mt-auto flex items-center justify-center gap-2 py-3.5 md:py-4 rounded-xl text-[14px] md:text-[15px] font-bold transition-all duration-300 ${
                    pkg.popular 
                    ? "bg-linear-to-r from-purple-600 to-purple-500 hover:from-purple-500 hover:to-purple-400 text-white shadow-[0_0_20px_rgba(168,85,247,0.4)]" 
