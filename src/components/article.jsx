  ...
  if (isLoading) {
    return (
      <div className="min-h-dvh bg-[#030712] flex flex-col items-center justify-center gap-4 pt-28">
        ...
        <h2 className="text-slate-400 font-jakarta text-lg m-0">
    ...
    return (
      <div className="min-h-dvh bg-[#030712] flex flex-col items-center justify-center pt-28 font-jakarta">
        <div className="bg-[#0a0f1c] border border-white/10 rounded-3xl p-12 text-center max-w-lg shadow-2xl">
          <h2 className="text-3xl font-black text-white mb-4 m-0">
            Article Not Found
          </h2>
  ...
  return (
    <article className="min-h-dvh bg-[#030712] text-white font-jakarta pt-28 sm:pt-36 pb-24 relative">
      <Helmet>
        ...
        <meta
          name="description"
          content={post.excerpt || "Read this insightful article on CodeLume."}
        />
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
          ...
          <aside className="w-full lg:w-1/3 lg:sticky lg:top-32 self-start space-y-8">
            <div className="bg-[#0a0f1c] border border-white/5 rounded-3xl p-8 relative overflow-hidden shadow-xl">
              ...
              <h2 className="text-xl font-black text-white mb-2 m-0">
                About the Author
              </h2>
              <p className="text-slate-400 text-sm leading-relaxed mb-6">
                Hi, I'm Rafay. A bespoke freelance web developer and UI/UX
                designer. I help ambitious brands scale by engineering
                high-performance digital platforms and driving targeted SEO
                traffic.
              </p>
              <Link
                to="/about"
            ...
            <div className="bg-linear-to-br from-blue-900/40 to-[#0a0f1c] border border-blue-500/20 rounded-3xl p-8 shadow-[0_0_30px_rgba(37,99,235,0.1)]">
              <h2 className="text-xl font-black text-white mb-3 m-0">
                Need a Website?
              </h2>
              <p className="text-slate-300 text-sm leading-relaxed mb-6">
                Stop losing clients to slow, outdated websites. Let's build a
                bespoke digital solution tailored exactly to your business
                logic.
              </p>
              <Link
                to="/start-project"
