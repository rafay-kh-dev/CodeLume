        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            ...
            <div className="relative w-full z-20 animate-float lg:pl-6 transform-gpu mt-8 lg:mt-0">
              {/* 🚀 FIXED: Removed deeply nested blur filters. Reduced heavy nested drop-shadows */}
              <div className="relative rounded-2xl bg-[#0a0f1c]/70 backdrop-blur-xl p-1 shadow-[0_20px_50px_rgba(0,0,0,0.5)] ring-0">
                ...
                <div className="relative rounded-xl bg-[#0d1117]/95 overflow-hidden flex flex-col shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]">
                  <div className="flex items-center justify-between px-4 sm:px-5 bg-[#161b22]/90 shadow-[0_10px_20px_rgba(0,0,0,0.3)] relative z-10">
                  ...
                  <div className="flex items-center justify-between px-4 sm:px-5 py-2.5 bg-[#0a0d14] shadow-[0_-10px_20px_rgba(0,0,0,0.4)] relative z-10">
